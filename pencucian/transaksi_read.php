    ...
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <form method="POST" action="transaksi_update.php?id=<?php echo $t['id']; ?>&status=<?php echo $status; ?>">
...
<tr>
    ...
    <?php } ?>
        ...
        <td colspan="2">
            <textarea class="form-control" name="hasil_wawancara" rows="3" placeholder="Masukkan hasil wawancara di sini..."><?php echo isset($ps['hasil_wawancara']) ? htmlspecialchars($ps['hasil_wawancara']) : ''; ?></textarea>
        </td>
    </tr>
            ...
            <input type="submit" class="btn btn-primary" value="Simpan">   
                <a href="wawancara.php" class="btn btn-danger">Batal</a>
                </form>
        </div>
    </div>
</div>
